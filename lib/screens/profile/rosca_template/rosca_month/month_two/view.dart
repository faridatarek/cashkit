...
class RoscaMonthTwoScreen extends StatefulWidget {
  RoscaMonthTwoScreen({
    Key? key,
  }) : super(key: key);
  ...
  @override
  State<RoscaMonthTwoScreen> createState() => _RoscaMonthTwoScreenState();
}

class _RoscaMonthTwoScreenState extends State<RoscaMonthTwoScreen> {
  int totalPaid = 000;
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => RoscaMonthThreeScreen(),
                ));
          },
