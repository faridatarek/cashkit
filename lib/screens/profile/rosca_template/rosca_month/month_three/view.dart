...
class RoscaMonthThreeScreen extends StatefulWidget {
  ...
  @override
  State<RoscaMonthThreeScreen> createState() => _RoscaMonthThreeScreenState();
}

class _RoscaMonthThreeScreenState extends State<RoscaMonthThreeScreen> {
  int totalPaid = 000;
