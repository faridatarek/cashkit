                      ...
                      child: Row(
                        children: [
                          Padding(
                            ...
                            child: CircleAvatar(child: selectedImg_emergency, backgroundColor: Color(0xffEFEFEF), radius: 25.r),
                          ),
                          SizedBox(width: 15.w),
                          Text(
                            selectedCategoryName_emergency,
                            style: TextStyle(fontSize: 15.sp, color: Color(0xffBDBDBD), fontWeight: FontWeight.w800),
                          ),
                          Spacer(),
                          Padding(
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: ListTile(
                          leading:CircleAvatar(child:   categories_emergency[index]['image'],backgroundColor: Color(0xffEFEFEF),radius: 28.r),
