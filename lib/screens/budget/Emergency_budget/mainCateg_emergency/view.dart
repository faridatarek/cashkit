                      ...
                      child: Row(
                        children: [
                          Padding(
                            ...
                            child: CircleAvatar(child: selectedImg_emergency, backgroundColor: Color(0xffEFEFEF), radius: 30.r),
                          ),
                          SizedBox(width: 15.w),
                          Text(
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: ListTile(
                        leading:CircleAvatar(child:   categories_emergency[index]['image'],backgroundColor: Color(0xffEFEFEF),radius: 30.r),
