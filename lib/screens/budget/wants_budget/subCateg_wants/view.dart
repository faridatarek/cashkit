              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  Padding(
                    ...
                    child: CircleAvatar(child: selectedimgCategory_wants,backgroundColor: Color(0xffEFEFEF),radius: 28.r),
                  ),
                  SizedBox(width: 15.w,),
                  Text(
                    ...
                    return Column(
                      children: [
                        ...
                        Container(
                          ...
                          child:  Center(
                            child: ListTile(
                              leading:CircleAvatar(child:filteredSubcategories_wants[index]['image'],backgroundColor: Color(0xffEFEFEF),radius: 25.r),
                              title: Text(filteredSubcategories_wants[index]['name'], style: TextStyle(color: Color(0xff292929),fontWeight: FontWeight.w500,fontSize: 15.sp), ),
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
