        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(8.r),color: Colors.white,),height: 170.h,
                child: Column(
                    children: [
                  InkWell(
                    onTap: () {
                      ...
                      child: Row(
                        children: [
                          Padding(
                            ...
                            child: CircleAvatar(child: selectedImg_wants, backgroundColor: Color(0xffEFEFEF), radius: 25.r),
                          ),
                          SizedBox(width: 15.w),
                          Text(
                      ...
                      child: Center(
                        child: TextFormField(
                          decoration: InputDecoration(
                            label: Text(
                              "Amount",
                              style: TextStyle(fontSize: 15.sp, color: Color(0xff9B9B9B), fontWeight: FontWeight.w500),
                            ),
                            icon: CircleAvatar(
                              child: Image.asset(
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      ], color: Colors.white,borderRadius: BorderRadiusDirectional.circular(8.r)),


                      child: Center(
                        child: ListTile(
                          leading:CircleAvatar(child:   categories_wants[index]['image'],backgroundColor: Color(0xffEFEFEF),radius: 28.r),

                          title: Text(
                            categories_wants[index]['name'],
                            style: TextStyle(color: Color(0xff292929),fontWeight: FontWeight.w600,fontSize: 16.sp),
                          ),
                          onTap: () {
